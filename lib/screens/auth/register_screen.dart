...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      // Si el usuario se registró como trabajador, invitarlo a crear su primer gig
      if (_role == UserRole.worker) {
        final createGig = await showDialog<bool>(
          context: context,
          builder: (context) => AlertDialog(
            title: const Text('¡Bienvenido a ManoVecina!'),
            content: const Text(
              '¿Querés crear tu primer servicio ahora? Esto te ayudará a que los clientes te encuentren más rápido.',
            ),
            actions: [
              TextButton(
        ...
        if (createGig == true && mounted) {
          // Navegar a la pantalla de crear gig
      ...
      // Si es cliente o si el trabajador no quiere crear gig, volver al login
