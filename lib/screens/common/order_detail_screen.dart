          ...
          : Padding(
              ...
              child: ListView(
                children: [
                  ...
                  // Botón de reseña para AMBOS (cliente Y trabajador) si la orden está completada
                  if (o.status == OrderStatus.completed) ...[
                    // Trabajador puede reseñar si no ha dejado workerRating
                    if (isWorker && o.workerRating == null) ...[
                      const SizedBox(height: 14),
                      PrimaryButton(
                    ...
                    // Cliente puede reseñar si no ha dejado clientRating
                    if (!isWorker && o.clientRating == null) ...[
                      const SizedBox(height: 14),
                      PrimaryButton(
                        onPressed: _openReviewModal,
                        child: Row(
